...
storage/tokudb/PerconaFT/src/tokufractaltree_static_depends.cc: storage/tokudb/PerconaFT/./snappy/lib/libsnappy.a
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating tokufractaltree_static_depends.cc"
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && /usr/bin/cmake -E touch /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/tokufractaltree_static_depends.cc
...
storage/tokudb/PerconaFT/src/CMakeFiles/tokufractaltree_static.dir/tokufractaltree_static_depends.cc.o: storage/tokudb/PerconaFT/src/tokufractaltree_static_depends.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object storage/tokudb/PerconaFT/src/CMakeFiles/tokufractaltree_static.dir/tokufractaltree_static_depends.cc.o"
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && /usr/bin/g++-8  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/tokufractaltree_static.dir/tokufractaltree_static_depends.cc.o -c /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/tokufractaltree_static_depends.cc
...
storage/tokudb/PerconaFT/src/libtokufractaltree_static.a: storage/tokudb/PerconaFT/src/CMakeFiles/tokufractaltree_static.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library libtokufractaltree_static.a"
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && $(CMAKE_COMMAND) -P CMakeFiles/tokufractaltree_static.dir/cmake_clean_target.cmake
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/tokufractaltree_static.dir/link.txt --verbose=$(VERBOSE)
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && rm /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/libtokufractaltree_static.a
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && /usr/bin/cmake -D TARGET_FILE=/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/libtokufractaltree_static.a -D STATIC_LIB_FILES="/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/libtokudb_static_conv.a;/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/locktree/liblocktree_static.a;/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/ft/libft_static.a;/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/util/libutil_static.a;/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/./xz/lib/liblzma.a;/mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/./snappy/lib/libsnappy.a" -P /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src/merge_archives_tokufractaltree_static.cmake
...
storage/tokudb/PerconaFT/src/CMakeFiles/tokufractaltree_static.dir/clean:
	cd /mnt/jenkins/workspace/ps8.0-autobuild-RELEASE/test/percona-server/storage/tokudb/PerconaFT/src && $(CMAKE_COMMAND) -P CMakeFiles/tokufractaltree_static.dir/cmake_clean.cmake
