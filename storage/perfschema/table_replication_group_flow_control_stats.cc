...
/**
  @file storage/perfschema/table_replication_group_flow_control_stats.cc
  Table replication_group_flow_control_stat (implementation).
*/

#include "storage/perfschema/table_replication_group_flow_control_stats.h"
...
/*
  ...
  GROUP_REPLICATION_FLOW_CONTROL_STATS_CALLBACKS.
*/

static void set_member_host(void *const context, const char &value,
                            size_t length) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
...
static void set_stat_between_50_and_100(void *const context,
                                        unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_between_50_and_100 = value;
}
...
static void set_stat_between_1000_and_2000(void *const context,
                                           unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_between_1000_and_2000 = value;
}

static void set_stat_between_2000_and_3000(void *const context,
                                           unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_between_2000_and_3000 = value;
}

static void set_stat_between_3000_and_4000(void *const context,
                                           unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_between_3000_and_4000 = value;
}

static void set_stat_between_4000_and_5000(void *const context,
                                           unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_between_4000_and_5000 = value;
}

static void set_stat_larger_than_5000(void *const context,
                                      unsigned long long int value) {
  struct st_row_group_flow_control_stat *row =
      static_cast<struct st_row_group_flow_control_stat *>(context);
  row->stat_more_than_5000 = value;
}

THR_LOCK table_replication_group_flow_control_stats::m_table_lock;

Plugin_table table_replication_group_flow_control_stats::m_table_def(
    /* Schema name */
    "performance_schema",
    /* Name */
    "replication_group_flow_control_stats",
    /* Definition */
    ...
    "  between_50_and_100 BIGINT unsigned not null,\n"
    ...
    "  between_500_and_1000 BIGINT unsigned not null,\n"
    "  between_1000_and_2000 BIGINT unsigned not null,\n"
    "  between_2000_and_3000 BIGINT unsigned not null,\n"
    "  between_3000_and_4000 BIGINT unsigned not null,\n"
    "  between_4000_and_5000 BIGINT unsigned not null,\n"
    "  more_than_5000 BIGINT unsigned not null\n",
    /* Options */
    " ENGINE=PERFORMANCE_SCHEMA",
    /* Tablespace */
    nullptr);

PFS_engine_table_share table_replication_group_flow_control_stats::m_share = {
    &pfs_readonly_acl,
    &table_replication_group_flow_control_stats::create,
    nullptr, /* write_row */
    nullptr, /* delete_all_rows */
    table_replication_group_flow_control_stats::get_row_count,
...
PFS_engine_table *table_replication_group_flow_control_stats::create(
    PFS_engine_table_share *) {
  return new table_replication_group_flow_control_stats();
}

table_replication_group_flow_control_stats::
    table_replication_group_flow_control_stats()
    : PFS_engine_table(&m_share, &m_pos), m_pos(0), m_next_pos(0) {}

table_replication_group_flow_control_stats::
    ~table_replication_group_flow_control_stats() = default;

void table_replication_group_flow_control_stats::reset_position(void) {
  m_pos.m_index = 0;
  m_next_pos.m_index = 0;
}

ha_rows table_replication_group_flow_control_stats::get_row_count() {
  return 1;
}

int table_replication_group_flow_control_stats::rnd_next(void) {
...
int table_replication_group_flow_control_stats::rnd_pos(const void *pos) {
  if (!is_group_replication_plugin_loaded()) {
    return HA_ERR_END_OF_FILE;
  }
...
int table_replication_group_flow_control_stats::make_row(uint index) {
  DBUG_TRACE;
  // Set default values.
  ...
  m_row.stat_between_50_and_100 = 0;
  ...
  m_row.stat_between_1000_and_2000 = 0;
  m_row.stat_between_2000_and_3000 = 0;
  m_row.stat_between_3000_and_4000 = 0;
  m_row.stat_between_4000_and_5000 = 0;
  m_row.stat_more_than_5000 = 0;
  ...
  const GROUP_REPLICATION_FLOW_CONTROL_STATS_CALLBACKS callbacks = {
      ...
      &set_stat_between_1000_and_2000,
      &set_stat_between_2000_and_3000,
      &set_stat_between_3000_and_4000,
      &set_stat_between_4000_and_5000,
      &set_stat_larger_than_5000,
  };

  // Query plugin and let callbacks do their job.
  if (get_group_replication_flow_control_stats_info(index, callbacks)) {
...
int table_replication_group_flow_control_stats::read_row_values(
    ...
    if (read_all || bitmap_is_set(table->read_set, f->field_index())) {
      switch (f->field_index()) {
        ...
        case 6:
          ...
          break;
        case 7:
          set_field_ulonglong(f, m_row.stat_between_50_and_100);
          break;
        case 8:
        ...
        case 12:
          ...
          break;
        case 13:
          set_field_ulonglong(f, m_row.stat_between_1000_and_2000);
          break;
        case 14:
          set_field_ulonglong(f, m_row.stat_between_2000_and_3000);
          break;
        case 15:
          set_field_ulonglong(f, m_row.stat_between_3000_and_4000);
          break;
        case 16:
          set_field_ulonglong(f, m_row.stat_between_4000_and_5000);
          break;
        case 17:
          set_field_ulonglong(f, m_row.stat_more_than_5000);
          break;
